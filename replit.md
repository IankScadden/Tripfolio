...
- **Tip Jar (Phase 1)**: Visitors can tip trip creators via "Buy Me a Coffee" button on public trip pages (/explore/:id and /share/:shareId). Supports fixed amounts ($3, $5, $10) via Stripe Checkout. Currently all tips go to platform owner - Phase 2 will enable Stripe Connect for creator payouts. Success page at /tip-success shows thank you message with navigation options.
